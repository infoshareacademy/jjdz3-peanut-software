...
public class Question {
    ...
    public String getAnswerExpectedType() {
        return answerExpectedType;
    }

    public void setAnswerExpectedType(String answerExpectedType) {
        this.answerExpectedType = answerExpectedType;
    }
...
//        System.out.println("answerType:"+answerType);
        ...
        if(!answerType.equals(this.answerExpectedType))
        {
            System.out.println("Niepoprawna odpowiedź! Oczekiwana:"+ this.answerExpectedType+". Wpisano: "+answerType);
            return false;
        }
        return true;
    }
